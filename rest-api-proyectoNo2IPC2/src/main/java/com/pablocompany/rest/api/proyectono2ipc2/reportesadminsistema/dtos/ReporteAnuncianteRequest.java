 ...
 * @author pablo
 */
//Clase delegada para poder procesar el request del reporte de anunciante
public class ReporteAnuncianteRequest {
    ...
    public ReporteAnuncianteRequest(LocalDate fechaInicio, LocalDate fechaFin, int offset, int limit) {
    ...
    public ReporteAnuncianteRequest(String idUsuario, LocalDate fechaInicio, LocalDate fechaFin, int offset, int limit) {
    ...
    public ReporteAnuncianteRequest(int offset, int limit) {
        this.offset = offset;
        this.limit = limit;
        this.estaVacia = true;
    }
    ...
    public boolean validarRequestFiltro() throws FormatoInvalidoException {
        ...
        try {
            ...
            if (StringUtils.isEmpty(this.idUsuario)) {
