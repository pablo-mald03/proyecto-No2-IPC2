 ...
 * @author pablo
 */
@Path("reportes/sistema/ganancias/anunciantes/exportar")
public class ExportarReporteGananciasAnuncianteResource {
    ...
    public Response reporteComentariosFiltro(
        ...
        try {
            List<ReporteAnuncianteDTO> reporteGananciasDto = reporteGananciasAnuncianteService.obtenerReporteConFiltro(idUsuario, fechaInicio, fechaFin, limite, inicio);
