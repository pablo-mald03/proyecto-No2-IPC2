...
public class ReporteAnuncioDTO {
    ...
    public ReporteAnuncioDTO(String codigo, boolean estado, String nombre, boolean caducacion, LocalDate fechaExpiracion, LocalDate fechaCompra, String url, String texto, String foto, int codigoTipo, String idUsuario, String nombreUsuario) {
        this.codigo = codigo;
        this.estado = estado;
        this.nombre = nombre;
